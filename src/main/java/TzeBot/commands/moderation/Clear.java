...
public class Clear implements ICommand {
        ...
        if (!member.hasPermission(Permission.MANAGE_SERVER)) {
            ...
            try {
                ...
                if (exception.toString().startsWith("java.lang.IllegalArgumentException")) {
                    EmbedBuilder error = new EmbedBuilder();
                    error.setColor(0xff3923);
                    error.setTitle(TzeBot.essentials.LanguageDetector.getMessage("general.icon.error") + TzeBot.essentials.LanguageDetector.getMessage("clear.unsuitable.setTitle"));
                    error.setDescription(TzeBot.essentials.LanguageDetector.getMessage("clear.unsuitable.setDescription"));
                    ...
                    EmbedBuilder error = new EmbedBuilder();
                    error.setColor(0xff3923);
                    error.setTitle(TzeBot.essentials.LanguageDetector.getMessage("general.icon.error") + TzeBot.essentials.LanguageDetector.getMessage("clear.older.setTitle"));
                    error.setDescription(TzeBot.essentials.LanguageDetector.getMessage("clear.older.setDescription"));
    ...
    public String getName() {
        return TzeBot.essentials.LanguageDetector.getMessage("clear.name");
    }

    @Override
    public String getHelp() {
        return TzeBot.essentials.LanguageDetector.getMessage("clear.gethelp");
    }
}
