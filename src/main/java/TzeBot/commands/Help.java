    ...
    public void handle(CommandContext ctx) {
        ...
        if (args.get(0).equals(TzeBot.essentials.LanguageDetector.getMessage("music.name"))) {
            ...
            info.setDescription(TzeBot.essentials.LanguageDetector.getMessage("help.music.info.setDescription")
                            + "\n" + TzeBot.essentials.LanguageDetector.getMessage("music.icon") + "`" + prefix + TzeBot.essentials.LanguageDetector.getMessage("channel.name") + "`" + ": " + TzeBot.essentials.LanguageDetector.getMessage("channel.gethelp")
                            ...
                            + "\n" + TzeBot.essentials.LanguageDetector.getMessage("general.icon.play") + "`" + prefix + TzeBot.essentials.LanguageDetector.getMessage("resume.name") + "`" + ": " + TzeBot.essentials.LanguageDetector.getMessage("resume.gethelp")
        ...
        if (args.get(0).equals(TzeBot.essentials.LanguageDetector.getMessage("moderation.name"))) {
            ...
            info.setDescription(TzeBot.essentials.LanguageDetector.getMessage("help.moderation.info.setDescription")
                            ...
                            + "\n" + TzeBot.essentials.LanguageDetector.getMessage("general.icon.vote") + "`" + prefix + TzeBot.essentials.LanguageDetector.getMessage("voterole.name") + "`" + ": " + TzeBot.essentials.LanguageDetector.getMessage("voterole.gethelp"));
            info.setColor(0x6699ff);
            info.setFooter(TzeBot.essentials.LanguageDetector.getMessage("help.info.setFooter"), "https://cdn.discordapp.com/avatars/217668226845245440/8326b24c3961afa0b3727a771220719e.png");
