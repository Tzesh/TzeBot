...
public class Listener extends ListenerAdapter {
    ...
    public void onGuildMessageReactionRemove(GuildMessageReactionRemoveEvent event) {
        if (Config.VOTEROLES.containsKey(event.getMessageIdLong())) {
            ...
            switch (roleIDs.size()) {
                case 2:
                    if (event.getReactionEmote().getEmoji().equals(TzeBot.essentials.LanguageDetector.getMessage("general.icon.1"))) {
                        event.getGuild().removeRoleFromMember(event.getGuild().getMemberById(event.getMember().getIdLong()), event.getGuild().getRoleById(roleIDs.get(0))).queue();
                    } if (event.getReactionEmote().getEmoji().equals(TzeBot.essentials.LanguageDetector.getMessage("general.icon.2"))) {
                        event.getGuild().removeRoleFromMember(event.getGuild().getMemberById(event.getMember().getIdLong()), event.getGuild().getRoleById(roleIDs.get(1))).queue();
                    }
                    break;
                case 3:
                    if (event.getReactionEmote().getEmoji().equals(TzeBot.essentials.LanguageDetector.getMessage("general.icon.1"))) {
                        ...
                        event.getGuild().removeRoleFromMember(event.getGuild().getMemberById(event.getMember().getIdLong()), event.getGuild().getRoleById(roleIDs.get(1))).queue();
                    } if (event.getReactionEmote().getEmoji().equals(TzeBot.essentials.LanguageDetector.getMessage("general.icon.3"))) {
                        event.getGuild().removeRoleFromMember(event.getGuild().getMemberById(event.getMember().getIdLong()), event.getGuild().getRoleById(roleIDs.get(2))).queue();
                    }
                    break;
                case 4:
                    if (event.getReactionEmote().getEmoji().equals(TzeBot.essentials.LanguageDetector.getMessage("general.icon.1"))) {
                        ...
                        event.getGuild().removeRoleFromMember(event.getGuild().getMemberById(event.getMember().getIdLong()), event.getGuild().getRoleById(roleIDs.get(2))).queue();
                    } if (event.getReactionEmote().getEmoji().equals(TzeBot.essentials.LanguageDetector.getMessage("general.icon.4"))) {
                        event.getGuild().removeRoleFromMember(event.getGuild().getMemberById(event.getMember().getIdLong()), event.getGuild().getRoleById(roleIDs.get(3))).queue();
                    }
                    break;
                default:
                    break;
    ...
    public void onGuildMessageReactionAdd(GuildMessageReactionAddEvent event) {
        ...
        if (IDs != null) {
            ...
            if (IDs.containsValue(event.getMessageIdLong())) {
                    if (event.getReactionEmote().getEmoji().equals(TzeBot.essentials.LanguageDetector.getMessage("general.icon.join"))) {
                        ...
                        channel.sendMessage(error.build()).queue(message -> {                message.delete().queueAfter(5, TimeUnit.SECONDS);                });
                        error.clear();
                        return;
                        }
                        ...
                        succes.setFooter(TzeBot.essentials.LanguageDetector.getMessage("general.bythecommand") + event.getMember().getUser().getName(), event.getMember().getUser().getAvatarUrl());

                        channel.sendTyping().queue();
                        channel.sendMessage(succes.build()).queue(message -> {                message.delete().queueAfter(5, TimeUnit.SECONDS);                });
                        succes.clear();
                    } if (event.getReactionEmote().getEmoji().equals(TzeBot.essentials.LanguageDetector.getMessage("general.icon.leave"))) {
                        ...
                        success.setFooter(TzeBot.essentials.LanguageDetector.getMessage("general.bythecommand") + " " + event.getMember().getUser().getName(), event.getMember().getUser().getAvatarUrl());

                        channel.sendTyping().queue();
                        channel.sendMessage(success.build()).queue(message -> {                message.delete().queueAfter(5, TimeUnit.SECONDS);                });
                        success.clear();
                        }
                        ...
                        channel.sendMessage(success.build()).queue(message -> {                message.delete().queueAfter(5, TimeUnit.SECONDS);                });
                        success.clear();
                    } if (event.getReactionEmote().getEmoji().equals(TzeBot.essentials.LanguageDetector.getMessage("general.icon.pause"))) {
                        if (player.getPlayingTrack() == null) {
                        event.getChannel().removeReactionById(event.getMessageId(), event.getReactionEmote().getEmoji(), event.getUser()).queue();
                        EmbedBuilder error = new EmbedBuilder();
                        error.setColor(0xff3923);
                    ...
                    } if (event.getReactionEmote().getEmoji().equals(TzeBot.essentials.LanguageDetector.getMessage("general.icon.stop"))) {
                        if (audioManager.isConnected()) {
                        audioManager.closeAudioConnection();
                        event.getChannel().removeReactionById(event.getMessageId(), event.getReactionEmote().getEmoji(), event.getUser()).queue();
                    ...
                    } if (event.getReactionEmote().getEmoji().equals(TzeBot.essentials.LanguageDetector.getMessage("general.icon.play"))) {
                        if (player.getPlayingTrack() == null) {
                        event.getChannel().removeReactionById(event.getMessageId(), event.getReactionEmote().getEmoji(), event.getUser()).queue();
                        EmbedBuilder error = new EmbedBuilder();
                        error.setColor(0xff3923);
                    ...
                    } if (event.getReactionEmote().getEmoji().equals(TzeBot.essentials.LanguageDetector.getMessage("general.icon.skip"))) {
                        if (player.getPlayingTrack() == null) {
                        event.getChannel().removeReactionById(event.getMessageId(), event.getReactionEmote().getEmoji(), event.getUser()).queue();
                        EmbedBuilder error = new EmbedBuilder();
                        error.setColor(0xff3923);
                        ...
                        scheduler.nextTrack();
                        event.getChannel().removeReactionById(event.getMessageId(), event.getReactionEmote().getEmoji(), event.getUser()).queue();
                    } if (event.getReactionEmote().getEmoji().equals(TzeBot.essentials.LanguageDetector.getMessage("general.icon.volume"))) {
                        if (playerManager.getGuildMusicManager(event.getGuild()).player.getVolume() + 10 > 100) {
                            ...
                            EmbedBuilder success = new EmbedBuilder();
                            success.setColor(0x00ff00);
                            success.setTitle(TzeBot.essentials.LanguageDetector.getMessage("general.icon.volume") + TzeBot.essentials.LanguageDetector.getMessage("volume.success.setTitle") + playerManager.getGuildMusicManager(event.getGuild()).player.getVolume() + "%");
                            success.setFooter(TzeBot.essentials.LanguageDetector.getMessage("general.bythecommand") + " " + event.getMember().getUser().getName(), event.getMember().getUser().getAvatarUrl());
                        ...
                        channel.sendMessage(success.build()).queue(message -> {                message.delete().queueAfter(5, TimeUnit.SECONDS);                });
                        success.clear();
                    } if (event.getReactionEmote().getEmoji().equals(TzeBot.essentials.LanguageDetector.getMessage("general.icon.volumedown"))) {
                        ...
                        channel.sendMessage(success.build()).queue(message -> {                message.delete().queueAfter(5, TimeUnit.SECONDS);                });
                        success.clear();
                    } if (event.getReactionEmote().getEmoji().equals(TzeBot.essentials.LanguageDetector.getMessage("general.icon.loop"))) {
                    ...
                    } if (event.getReactionEmote().getEmoji().equals(TzeBot.essentials.LanguageDetector.getMessage("general.icon.queue"))) {
                        if (queue.isEmpty()) {
                        event.getChannel().removeReactionById(event.getMessageId(), event.getReactionEmote().getEmoji(), event.getUser()).queue();
                        EmbedBuilder error = new EmbedBuilder();
                        error.setColor(0xff3923);
                        ...
                        channel.sendMessage(builder.build()).queue(message -> {                message.delete().queueAfter(5, TimeUnit.SECONDS);                });
                    } if (event.getReactionEmote().getEmoji().equals(TzeBot.essentials.LanguageDetector.getMessage("general.icon.nowplaying"))) {
                        if (player.getPlayingTrack() == null) {
                        event.getChannel().removeReactionById(event.getMessageId(), event.getReactionEmote().getEmoji(), event.getUser()).queue();
                        EmbedBuilder error = new EmbedBuilder();
                        error.setColor(0xff3923);
                        ...
                        )).build()).queue(message -> {                message.delete().queueAfter(5, TimeUnit.SECONDS);                });
                    } if (event.getReactionEmote().getEmoji().equals(TzeBot.essentials.LanguageDetector.getMessage("general.icon.next"))) {
                        if (player.getPlayingTrack() == null) {
                        event.getChannel().removeReactionById(event.getMessageId(), event.getReactionEmote().getEmoji(), event.getUser()).queue();
                        EmbedBuilder error = new EmbedBuilder();
                        error.setColor(0xff3923);
                    ...
                    } if (event.getReactionEmote().getEmoji().equals(TzeBot.essentials.LanguageDetector.getMessage("general.icon.previous"))) {
                        if (player.getPlayingTrack() == null) {
                        event.getChannel().removeReactionById(event.getMessageId(), event.getReactionEmote().getEmoji(), event.getUser()).queue();
                        EmbedBuilder error = new EmbedBuilder();
                        error.setColor(0xff3923);
                        ...
                        event.getChannel().removeReactionById(event.getMessageId(), event.getReactionEmote().getEmoji(), event.getUser()).queue();
                        scheduler.changePosition(-15);
                    } if (event.getReactionEmote().getEmoji().equals(TzeBot.essentials.LanguageDetector.getMessage("general.icon.shuffle"))) {
                        if (musicManager.scheduler.getQueue().isEmpty() && musicManager.player.getPlayingTrack() == null) {
                        EmbedBuilder error = new EmbedBuilder();
                        error.setColor(0xff3923);
                        error.setTitle(TzeBot.essentials.LanguageDetector.getMessage("general.icon.error") + TzeBot.essentials.LanguageDetector.getMessage("loop.error.setTitle"));
    ...
    public void onGuildMessageDelete(GuildMessageDeleteEvent event) {
        if (Config.VOTEROLES.containsKey(event.getMessageIdLong())) Config.VOTEROLES.remove(event.getMessageIdLong());
        if (Config.MUSICCHANNELS.containsKey(event.getMessageIdLong())) Config.MUSICCHANNELS.remove(event.getGuild().getIdLong());
