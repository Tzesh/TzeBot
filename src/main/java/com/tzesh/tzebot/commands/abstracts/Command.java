...
public interface Command<T extends GenericMessageEvent> {
    ...
    String getName(long guildID); // Name of the code -> LanguageDetector.get("command.name", this.guildChannel.getLanguage());

    String getHelp(long guildID); // Help line of the code but both are will be called in LanguageDetector.get("command.gethelp", this.guildChannel.getLanguage());
